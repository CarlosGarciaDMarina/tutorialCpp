...
int main()
{
    ...
    //Tipico while para recorrer linea a linea, la funcion eof() significa fin de fichero
    while ( !(fr.eof()) )
    {
        //getLine sirve para capturar las lineas del fichero getline(donde lo metes, variable para almacenar)
        getline(fr, lineaFicheroTexto);
